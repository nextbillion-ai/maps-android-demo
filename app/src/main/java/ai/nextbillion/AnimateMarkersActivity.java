...
import static com.nbmap.nbmapsdk.style.layers.PropertyFactory.iconIgnorePlacement;
import static com.nbmap.nbmapsdk.style.layers.PropertyFactory.iconImage;
import static com.nbmap.nbmapsdk.style.layers.PropertyFactory.iconRotate;
...
import com.nbmap.nbmapsdk.geometry.LatLngBounds;
...
public class AnimateMarkersActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private LatLng getRandomLatLng() {
        LatLngBounds bounds = nbmapMap.getProjection().getVisibleRegion().latLngBounds;
